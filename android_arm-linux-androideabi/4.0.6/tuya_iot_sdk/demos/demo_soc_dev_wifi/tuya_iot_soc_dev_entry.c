...
int main(void)
{
    ...
    PR_DEBUG("PRODUCT_KEY: %s", PRODUCT_KEY);
    PR_DEBUG("USER_SW_VER: %s", USER_SW_VER);
    PR_DEBUG("CFG_STORAGE_PATH: %s", CFG_STORAGE_PATH);
    PR_DEBUG("UUID: %s", UUID);
    PR_DEBUG("AUTHKEY: %s", AUTHKEY);
